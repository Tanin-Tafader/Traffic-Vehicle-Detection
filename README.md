...
Support for common vehicle classes (e.g., car, truck, bus, motorcycle)

Performance evaluation using FPS, detection accuracy, and processing time

Modular design for easy experimentation and extension

<img width="483" height="405" alt="image" src="https://github.com/user-attachments/assets/92ccc98a-ea4a-485d-844a-13435b3b965c" />
